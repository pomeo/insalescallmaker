$(document).ready(function() {
  ...
  $('#reg').validate({
    ...
    messages: {
      ...
      phone: {
        required: 'Введите номер телефона, например 4951234567',
        digits: 'Введите номер телефона, например 4951234567',
        minlength: 'Введите номер телефона, например 4951234567',
        maxlength: 'Введите номер телефона, например 4951234567'
      }
    },
    submitHandler: function(form) {
      $(form).ajaxSubmit({
